            ...
            <div class="sub-container">
                ...
                <div class="login_form_container">
                        ...
                        <table dir="rtl" class="form_table">
                            ...
                            <tr class="form_table_tr_extra"><td><asp:Button OnClick="btnLogin_OnClick" ID="btnLogin" CssClass="submit_btn_login_form" runat="server" Text="إرسال" /></td><td class="align_center" ><a href="login.aspx"  class="hyperlink_login_form">تسجيل الدخول</a>
                                <br/>
                                <a class="hyperlink_login_form" data-toggle="modal" data-target="#myModal2">مراسلة مدير الموقع</a>
