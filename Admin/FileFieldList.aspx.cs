...
public partial class Admin_FileFieldList : AdminPages
{
    string tablename = "FileField";
    private string editPage = "FileFieldOp.aspx?Op=Edit&id={0}";
    private string addPage = "FileFieldOp.aspx?Op=Add";
    public string name = "المعنين";
