...
public partial class Admin_FileSecurityList : AdminPages
{
    string tablename = "FileSecurity";
    private string editPage = "FileSecurityOp.aspx?Op=Edit&id={0}";
    private string addPage = "FileSecurityOp.aspx?Op=Add";
    public string name = "السرية";
    

    public Admin_FileSecurityList()
    {
