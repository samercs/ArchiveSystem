...
{
    string tablename = "Social";
    private string editPage = "SocialOp.aspx?Op=Edit&id={0}";
    private string addPage = "SocialOp.aspx?Op=Add";
    public string name = "روابط التواصل الاجتماعي";
