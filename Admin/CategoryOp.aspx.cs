...
public partial class Admin_CategoryOp : System.Web.UI.Page
{
    string tablename = "Category";
    string listpage = "CategoryList.aspx";
    ...
    void LoadData()
    {
        ...
        ddlCatId.SelectedValue = ds.Tables[0].Rows[0]["catId"].ToString();
    }
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        db.AddParameter("@catId", ddlCatId.SelectedValue);
        ...
        if (Request.QueryString["Op"].Equals("Edit"))
        {
            ...
            {
                db.AddParameter("@id", Request.QueryString["id"]);
                db.ExecuteNonQuery("Update " + tablename + " Set title=@title,catId=@catId where Id=@id");
        ...
        {
            db.ExecuteNonQuery("Insert into " + tablename + "(Title,CatId) Values(@Title,@CatId)");
