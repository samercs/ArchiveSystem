<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="FileNoticeList.aspx.cs" Inherits="Admin_FileNoticeList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:HyperLink ID="HyperLink3" style="display:none;" NavigateUrl="" CssClass="tdn fr" runat="server"><h5><i class="fa fa-plus-square-o"></i>  اضافة جديد</h5></asp:HyperLink>
            ...
            <table cellspacing='0' class="LoginTbl tblList">
                ...
                <asp:ListView  ID="RepeaterLists" OnPagePropertiesChanged="ListView1_PagePropertiesChanged" ItemPlaceholderID="iph" runat="server">
                    ...
                    <ItemTemplate>
                        <tr class="<%#Eval("isShow").ToString().Equals("True") ?  "read" : "unread" %>">
                            <td>
