...
public partial class Admin_CategoryOp : AdminPages
{
    string tablename = "Social";
    string listpage = "SocialList.aspx";
    ...
    void LoadData()
    {
        ...
        txtTitle.Text = ds.Tables[0].Rows[0]["Link"].ToString();
    }
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterStartupScript(this, this.GetType(), "WriteMsg", "<SCRIPT LANGUAGE=\"JavaScript\">alertify.error(\"الرجاء اختيار الرابط.\")</SCRIPT>", false);
            return;
        }
        

        db.AddParameter("@Link", txtTitle.Text);
        ...
        if (Request.QueryString["Op"].Equals("Edit"))
        {
            ...
            {
                db.AddParameter("@id", Request.QueryString["id"]);
                db.ExecuteNonQuery("Update " + tablename + " Set Link=@Link where Id=@id");
        ...
        {
            db.ExecuteNonQuery("Insert into " + tablename + "(Link) Values(@Link)");
