...
public partial class Admin_FileTargetList : AdminPages
{
    string tablename = "Filetarget";
    private string editPage = "FiletargetOp.aspx?Op=Edit&id={0}";
    private string addPage = "FiletargetOp.aspx?Op=Add";
    public string name = "المجال";
