...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <h1 class="Title BorderBottom">مدراء الموقع</h1>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:HyperLink ID="HyperLink3" NavigateUrl="AdminOp.aspx?Op=Add" CssClass="tdn fr" runat="server"><h5><i class="fa fa-plus-square-o"></i>اضافة مدير جديد</h5></asp:HyperLink>
