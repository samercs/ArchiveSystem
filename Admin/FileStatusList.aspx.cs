...
public partial class Admin_FileStatusList : AdminPages
{
    string tablename = "FileStatus";
    private string editPage = "FileStatusOp.aspx?Op=Edit&id={0}";
    private string addPage = "FileStatusOp.aspx?Op=Add";
    public string name = "حالة الملف";
