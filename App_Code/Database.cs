...
public class Database : IDisposable
{
    ...
    public Database(string connectionstring, Providers provider)
    {
        ...
        switch (provider)
        {
            ...
            case Providers.ConfigDefined:
                string providername = ConfigurationManager.ConnectionStrings["ArchiveSystem"].ProviderName;
                switch (providername)
                {
    ...
    public Database(Providers provider)
        : this(ConfigurationManager.ConnectionStrings["ArchiveSystem"].ConnectionString, provider)
    {
    }
    ...
    public Database()
        : this(ConfigurationManager.ConnectionStrings["ArchiveSystem"].ConnectionString, Providers.SqlServer)
    {
    }
    ...
    public void LoadDDL(string tablename, string pname, ref DropDownList ddl, string DefaultItemText,string where)
    {

        System.Data.DataTable dt = ExecuteDataTable("Select * from " + tablename+ " where " + where);
        ddl.Items.Add(new ListItem(DefaultItemText, "-1"));
        foreach (System.Data.DataRow r in dt.Rows)
        {
            ddl.Items.Add(new ListItem(r[pname].ToString(), r["id"].ToString()));
    ...
    public void LoadDDL(string tablename, string pname, string id, ref DropDownList ddl, string DefaultItemText,string where)
    {
